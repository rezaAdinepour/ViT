...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_phi_out { O 4 vector } p_phi_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_phi7_out \
    op interface \
    ports { p_phi7_out { O 4 vector } p_phi7_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName matmul_1_flow_control_loop_pipe_sequential_init_U
set CompName matmul_1_flow_control_loop_pipe_sequential_init
