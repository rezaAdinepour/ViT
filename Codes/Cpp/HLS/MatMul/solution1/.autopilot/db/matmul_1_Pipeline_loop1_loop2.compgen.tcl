...
set name matmul_1_fadd_32ns_32ns_32_3_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 2 ALLOW_PRAGMA 1
}


set name matmul_1_fmul_32ns_32ns_32_2_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set id 35
set name matmul_1_mux_3_2_32_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_C \
    op interface \
    ports { output_C_address0 { O 4 vector } output_C_ce0 { O 1 bit } output_C_we0 { O 1 bit } output_C_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'output_C'"
}
}
