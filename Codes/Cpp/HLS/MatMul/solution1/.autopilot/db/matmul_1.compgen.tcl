...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_1_output_C_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_C_TVALID { O 1 bit } out_C_TREADY { I 1 bit } out_C_TLAST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 79
set RegSliceName matmul_1_regslice_both
set RegSliceInstName matmul_1_regslice_both_U
set CoreName ap_simcore_matmul_1_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
