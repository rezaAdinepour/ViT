# 1 "Activation_quantzation/src/activation_quant.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Activation_quantzation/src/activation_quant.cpp" 2
...
#pragma pack(pop)
# 14 "C:/Xilinx/Vitis_HLS/2023.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\math.h" 2 3
...
using std::tgamma;
using std::trunc;
# 2 "Activation_quantzation/src/activation_quant.cpp" 2
# 1 "Activation_quantzation/src/activation_quant.h" 1
# 10 "Activation_quantzation/src/activation_quant.h"
float find_max_abs(float arr[], int length)
{
    float max_val = 0.0f;
    VITIS_LOOP_13_1: for (int i = 0; i < length; ++i)
    {
...
# 3 "Activation_quantzation/src/activation_quant.cpp" 2
...
__attribute__((sdx_kernel("activation_quant", 0))) void activation_quant(float input[3][3], float output[3][3])
{
#line 18 "C:/OneDrive/Desktop/ViT/Activation_quantzation/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=activation_quant
# 11 "Activation_quantzation/src/activation_quant.cpp"

#line 7 "C:/OneDrive/Desktop/ViT/Activation_quantzation/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=activation_quant
# 11 "Activation_quantzation/src/activation_quant.cpp"
...
#pragma HLS PIPELINE II=2
 ...
 VITIS_LOOP_16_1: for (int i = 0; i < 3; ++i)
    {
#pragma HLS UNROLL

 float max_val = find_max_abs(input[i], 3);
        float scale = 127.0f / clamp(max_val, 1e-5);

        VITIS_LOOP_23_2: for (int j = 0; j < 3; ++j)
        {
#pragma HLS UNROLL
