...
using hls::sim::Byte;
extern "C" void bit_linear(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_bit_linear_hw(volatile void * __xlx_apatb_param_input_0, volatile void * __xlx_apatb_param_input_1, volatile void * __xlx_apatb_param_input_2, volatile void * __xlx_apatb_param_input_3, volatile void * __xlx_apatb_param_weight_0, volatile void * __xlx_apatb_param_weight_1, volatile void * __xlx_apatb_param_output_0, volatile void * __xlx_apatb_param_output_1) {
...
__xlx_input_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_0)[i]);
  ...
  int __xlx_size_param_input_0 = 2;
...
__xlx_input_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_1)[i]);
  ...
  int __xlx_size_param_input_1 = 2;
...
__xlx_input_2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_2)[i]);
  ...
  int __xlx_size_param_input_2 = 2;
...
__xlx_input_3__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_3)[i]);
  ...
  int __xlx_size_param_input_3 = 2;
  int __xlx_offset_param_input_3 = 0;
  int __xlx_offset_byte_param_input_3 = 0*4;
  // Collect __xlx_weight_0__tmp_vec
std::vector<Byte<4>> __xlx_weight_0__tmp_vec;
for (size_t i = 0; i < 4; ++i){
__xlx_weight_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weight_0)[i]);
}
  int __xlx_size_param_weight_0 = 4;
  int __xlx_offset_param_weight_0 = 0;
  int __xlx_offset_byte_param_weight_0 = 0*4;
  // Collect __xlx_weight_1__tmp_vec
std::vector<Byte<4>> __xlx_weight_1__tmp_vec;
for (size_t i = 0; i < 4; ++i){
__xlx_weight_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weight_1)[i]);
}
  int __xlx_size_param_weight_1 = 4;
  int __xlx_offset_param_weight_1 = 0;
  int __xlx_offset_byte_param_weight_1 = 0*4;
...
__xlx_output_0__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_0)[i]);
  ...
  int __xlx_size_param_output_0 = 2;
...
__xlx_output_1__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_1)[i]);
  ...
  int __xlx_size_param_output_1 = 2;
  int __xlx_offset_param_output_1 = 0;
  int __xlx_offset_byte_param_output_1 = 0*4;
  // DUT call
  bit_linear(__xlx_input_0__tmp_vec.data(), __xlx_input_1__tmp_vec.data(), __xlx_input_2__tmp_vec.data(), __xlx_input_3__tmp_vec.data(), __xlx_weight_0__tmp_vec.data(), __xlx_weight_1__tmp_vec.data(), __xlx_output_0__tmp_vec.data(), __xlx_output_1__tmp_vec.data());
...
((Byte<4>*)__xlx_apatb_param_weight_0)[i] = __xlx_weight_0__tmp_vec[__xlx_offset_param_weight_0+i];
}
// print __xlx_apatb_param_weight_1
for (size_t i = 0; i < __xlx_size_param_weight_1; ++i) {
((Byte<4>*)__xlx_apatb_param_weight_1)[i] = __xlx_weight_1__tmp_vec[__xlx_offset_param_weight_1+i];
}
