...
module weight_quant_generic_round_float_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] data_9_fu_72_p1;
reg   [31:0] data_9_reg_205;
...
weight_quant_generic_round_float_s_mask_table_ROM_AUTO_1R #(
    .DataWidth( 23 ),
    .AddressRange( 32 ),
    .AddressWidth( 5 ))
mask_table_U(
...
weight_quant_generic_round_float_s_one_half_table_ROM_AUTO_1R #(
    .DataWidth( 24 ),
    .AddressRange( 32 ),
    .AddressWidth( 5 ))
one_half_table_U(
...
assign data_9_fu_72_p1 = x;

assign data_fu_133_p2 = (zext_ln175_fu_129_p1 + data_9_reg_205);

assign icmp_ln167_fu_86_p2 = ((xs_exp_fu_76_p4 < 8'd126) ? 1'b1 : 1'b0);

assign icmp_ln170_fu_92_p2 = ((xs_exp_fu_76_p4 > 8'd150) ? 1'b1 : 1'b0);

assign index_fu_98_p4 = {{data_9_fu_72_p1[27:23]}};

assign mask_table_address0 = zext_ln179_fu_108_p1;

assign one_half_table_address0 = zext_ln179_fu_108_p1;

assign select_ln167_fu_172_p3 = ((icmp_ln167_reg_211[0:0] == 1'b1) ? t_fu_121_p3 : t_10_fu_164_p3);

assign t_10_fu_164_p3 = {{tmp_fu_154_p4}, {xs_sig_fu_148_p2}};
