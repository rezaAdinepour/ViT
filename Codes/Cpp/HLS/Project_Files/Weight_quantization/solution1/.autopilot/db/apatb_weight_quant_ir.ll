; ModuleID = 'C:/OneDrive/Desktop/ViT/Weight_quantization/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_weight_quant_ir([3 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3" "partition" %input, [3 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="3" "partition" %output) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_weight_quant_hw([3 x float]* %input_copy_0, [3 x float]* %input_copy_1, [3 x float]* %input_copy_2, [3 x float]* %output_copy_0, [3 x float]* %output_copy_1, [3 x float]* %output_copy_2)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3f32.73.74(float* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, float* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, float* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x float]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [3 x float]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3a3f32.72.75([3 x float]* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, [3 x float]* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [3 x float]* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x [3 x float]]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [3 x [3 x float]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [3 x [3 x float]], [3 x [3 x float]]* %src, i64 0, i64 %for.loop.idx2
  call void @arraycpy_hls.p0a3f32.73.74(float* %dst.addr_0, float* %dst.addr_1, float* %dst.addr_2, [3 x float]* %src.addr, i64 3)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3a3f32.71.76([3 x float]* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, [3 x float]* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [3 x float]* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, [3 x [3 x float]]* noalias readonly "orig.arg.no"="1" %src) #4 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3a3f32.72.75([3 x float]* nonnull %dst_0, [3 x float]* %dst_1, [3 x float]* %dst_2, [3 x [3 x float]]* nonnull %src, i64 3)
  br label %ret
...
entry:
  call void @onebyonecpy_hls.p0a3a3f32.71.76([3 x float]* align 512 %_0, [3 x float]* align 512 %_1, [3 x float]* align 512 %_2, [3 x [3 x float]]* %0)
  call void @onebyonecpy_hls.p0a3a3f32.71.76([3 x float]* align 512 %_01, [3 x float]* align 512 %_12, [3 x float]* align 512 %_23, [3 x [3 x float]]* %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3f32.83.84([3 x float]* "orig.arg.no"="0" %dst, float* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, float* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, float* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i64 "orig.arg.no"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a3a3f32.82.85([3 x [3 x float]]* "orig.arg.no"="0" %dst, [3 x float]* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, [3 x float]* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, [3 x float]* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i64 "orig.arg.no"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @arraycpy_hls.p0a3f32.83.84([3 x float]* %dst.addr, float* %src.addr_0, float* %src.addr_1, float* %src.addr_2, i64 3)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a3a3f32.81.86([3 x [3 x float]]* noalias "orig.arg.no"="0" %dst, [3 x float]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, [3 x float]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, [3 x float]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2) #4 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a3a3f32.82.85([3 x [3 x float]]* nonnull %dst, [3 x float]* nonnull %src_0, [3 x float]* %src_1, [3 x float]* %src_2, i64 3)
  br label %ret
...
entry:
  call void @onebyonecpy_hls.p0a3a3f32.81.86([3 x [3 x float]]* %0, [3 x float]* align 512 %_0, [3 x float]* align 512 %_1, [3 x float]* align 512 %_2)
  call void @onebyonecpy_hls.p0a3a3f32.81.86([3 x [3 x float]]* %1, [3 x float]* align 512 %_01, [3 x float]* align 512 %_12, [3 x float]* align 512 %_23)
  ret void
}

declare void @apatb_weight_quant_hw([3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*)
...
define void @weight_quant_hw_stub_wrapper([3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*, [3 x float]*) #7 {
entry:
  ...
  call void @weight_quant_hw_stub([3 x float]* %8, [3 x float]* %9)
...
declare void @weight_quant_hw_stub([3 x float]*, [3 x float]*)
...
!22 = distinct !DISubprogram(name: "weight_quant", linkageName: "_Z12weight_quantPA3_fS0_", scope: !23, file: !23, line: 6, type: !24, isLocal: false, isDefinition: true, scopeLine: 7, flags: DIFlagPrototyped, isOptimized: false, unit: !31, variables: !4)
!23 = !DIFile(filename: "Weight_quantization/src/weight_quant.cpp", directory: "C:\5COneDrive\5CDesktop\5CViT")
...
!32 = !DIFile(filename: "C:/OneDrive/Desktop/ViT/Weight_quantization/solution1/.autopilot/db\5Cweight_quant.pp.0.cpp", directory: "C:\5COneDrive\5CDesktop\5CViT")
...
!389 = !DILocation(line: 9, column: 9, scope: !22)
