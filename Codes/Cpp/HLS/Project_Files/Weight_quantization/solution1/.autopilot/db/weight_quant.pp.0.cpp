# 1 "Weight_quantization/src/weight_quant.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "Weight_quantization/src/weight_quant.cpp" 2
...
using std::tgamma;
using std::trunc;
# 2 "Weight_quantization/src/weight_quant.cpp" 2
# 1 "Weight_quantization/src/weight_quant.h" 1
...
float abs_mean(float array[3][3])
{
    float sum = 0.0;
...
# 3 "Weight_quantization/src/weight_quant.cpp" 2



__attribute__((sdx_kernel("weight_quant", 0))) void weight_quant(float input[3][3], float output[3][3])
{
#line 17 "C:/OneDrive/Desktop/ViT/Weight_quantization/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=weight_quant
# 7 "Weight_quantization/src/weight_quant.cpp"

#line 7 "C:/OneDrive/Desktop/ViT/Weight_quantization/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=weight_quant
# 7 "Weight_quantization/src/weight_quant.cpp"
...
#pragma HLS PIPELINE II=2
 ...
 float mean = abs_mean(input);
    float scale = 1.0 / clamp(mean, 1e-5);

    VITIS_LOOP_15_1: for (int i = 0; i < 3; i++)
    {
#pragma HLS UNROLL
 VITIS_LOOP_18_2: for (int j = 0; j < 3; j++)
        {
#pragma HLS UNROLL
