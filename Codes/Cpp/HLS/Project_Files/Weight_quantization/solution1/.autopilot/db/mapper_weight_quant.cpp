...
using hls::sim::Byte;
extern "C" void weight_quant(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_weight_quant_hw(volatile void * __xlx_apatb_param_input_0, volatile void * __xlx_apatb_param_input_1, volatile void * __xlx_apatb_param_input_2, volatile void * __xlx_apatb_param_output_0, volatile void * __xlx_apatb_param_output_1, volatile void * __xlx_apatb_param_output_2) {
...
__xlx_output_2__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_2)[i]);
  ...
  // DUT call
  weight_quant(__xlx_input_0__tmp_vec.data(), __xlx_input_1__tmp_vec.data(), __xlx_input_2__tmp_vec.data(), __xlx_output_0__tmp_vec.data(), __xlx_output_1__tmp_vec.data(), __xlx_output_2__tmp_vec.data());
