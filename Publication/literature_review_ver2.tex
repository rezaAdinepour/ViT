...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	\begin{document}
		...
		\title{Ingure Thesis summrise (\texttt{reza})}
		
		
		% author names and affiliations
		% use a multiple column layout for up to three different
		% affiliations
		\author{\IEEEauthorblockN{Reza Adinepour}
			\IEEEauthorblockA{School of Electrical and\\Computer Engineering\\
				Amirkabir University of Technology\\
				Tehran, Iran 30332--0250\\
				Email: \texttt{adinepour@aut.ac.ir}}
			\and
			\IEEEauthorblockN{Farzane Arzaghi}
			\IEEEauthorblockA{School of Electrical and\\Computer Engineering\\
				Amirkabir University of Technology\\
				Tehran, Iran 30332--0250\\
				Email:\texttt{farzaghi@aut.ac.ir}}
			\and
...
%		\section*{Acknowledgment}
		...
		\textbf{I have not written all the references}
